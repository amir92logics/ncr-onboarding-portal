...
const APIStatus = () => {
    ...
    const [status] = useLazyAppstatusQuery()
    const { data: intial } = useAppstatusQuery()
    useEffect(() => {
        setInterval(() => {
            status()
                .unwrap()
        ...
        >
            ...
            >
                <Box component={"span"}>
                    ...
                    >
                        <title>{`This is API Status icon`}</title>
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
            ...
            {data ? (
                <Box
                    sx={{ border: "1px solid #e0e0e0", borderRadius: 2, mt: 8 }}
                >
                    <Table sx={{}} aria-label="Status table">
                        <TableBody sx={{}}>
