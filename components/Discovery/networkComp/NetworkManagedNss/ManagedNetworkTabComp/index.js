...
export const ManagedNetworkTabComp = (data, disable, network) => {
    ...
    return (
        <Box>
            {data.nestedArray ? (
                ...
                <Box>
                    {data?.data?.rowData?.map((item, index) => (
                        <Box
                            key={index}
                            display="flex"
                            flexDirection="column"
                            ...
                            flexWrap="wrap"
                            sx={{
                                borderTop: !data.contact && "1px solid #C9C9C9",
                                backgroundColor: "white",
                                mt: "-4px",
                        ...
                        >
                            ...
                            {data.contact && data?.data.head[1] && (
                                <Box>
                                    ...
                                    >
                                        {data?.data?.rowData[index][1]}
                                    </Typography>
                                </Box>
                            )}

                            {data.dataType !== "AddWebsite" && (
                                <Box
                                    sx={{
